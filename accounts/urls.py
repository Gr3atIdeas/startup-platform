...
urlpatterns = [
    ...
    re_path(r"^news/(?P<slug>[-\w]+)/delete/$", views.delete_news, name="delete_news"),
    path("news/comment/<int:comment_id>/delete/", views.delete_news_comment, name="delete_news_comment"),
