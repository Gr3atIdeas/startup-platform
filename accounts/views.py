...
FIXED_CATEGORIES = [
    {'original_name': 'AI', 'direction_name': 'ИИ', 'icon': 'ai.svg'},
    {'original_name': 'Auto', 'direction_name': 'Авто', 'icon': 'auto.svg'},
    {'original_name': 'Beauty', 'direction_name': 'Красота', 'icon': 'beauty.svg'},
    {'original_name': 'Cafe', 'direction_name': 'Кафе/рестораны', 'icon': 'cafe.svg'},
    {'original_name': 'Delivery', 'direction_name': 'Доставка', 'icon': 'delivery.svg'},
    {'original_name': 'Fastfood', 'direction_name': 'Фастфуд', 'icon': 'fastfood.svg'},
    {'original_name': 'Health', 'direction_name': 'Здоровье', 'icon': 'health.svg'},
    {'original_name': 'Healthcare', 'direction_name': 'Здравоохранение', 'icon': 'healthcare.svg'},
    {'original_name': 'Medicine', 'direction_name': 'Медицина', 'icon': 'medicine.svg'},
    {'original_name': 'Finance', 'direction_name': 'Финансы', 'icon': 'finance.svg'},
    {'original_name': 'Psychology', 'direction_name': 'Психология', 'icon': 'psychology.svg'},
    {'original_name': 'Technology', 'direction_name': 'Технологии', 'icon': 'technology.svg'},
    {'original_name': 'Sport', 'direction_name': 'Спорт', 'icon': 'sport.svg'},
    {'original_name': 'Transport', 'direction_name': 'Транспорт', 'icon': 'transport.svg'},
]
def home(request):
