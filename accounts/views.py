...
# ── FAQ data for franchise SEO pages ─────────────────────────

GENERAL_FRANCHISE_FAQ = [
    {"q": "Что такое франшиза и как она работает?", "a": "Франшиза — это право вести бизнес под известным брендом. Вы платите паушальный взнос и ежемесячные роялти, а взамен получаете проверенную бизнес-модель, обучение, поддержку и узнаваемый бренд."},
    {"q": "Сколько стоит купить франшизу в России?", "a": "Стоимость франшиз в России варьируется от 50 000 до 30 000 000 рублей. Средний диапазон — 500 000-3 000 000 рублей. В каталоге Great Ideas собраны предложения на любой бюджет."},
    {"q": "Как выбрать франшизу для покупки?", "a": "Определите бюджет, выберите интересную сферу, сравните 5-7 предложений, проверьте франчайзера (финансы, судебные дела, отзывы партнёров), изучите договор с юристом и составьте собственную финансовую модель."},
]

DIRECTION_FAQ = {
    "Beauty": [
        {"q": "Сколько стоит открыть франшизу салона красоты?", "a": "Стоимость франшизы в сфере красоты варьируется от 500 000 до 5 000 000 рублей в зависимости от формата — барбершоп, маникюрный салон или полноценный салон красоты. В стоимость обычно входят паушальный взнос, оборудование и обучение."},
        {"q": "Какой срок окупаемости у франшизы в бьюти-индустрии?", "a": "Средний срок окупаемости франшизы салона красоты составляет 12-24 месяца. Скорость зависит от локации, ценовой политики и маркетинговой активности."},
        {"q": "Нужен ли опыт для открытия франшизы салона красоты?", "a": "Большинство франчайзеров в бьюти-сфере не требуют опыта. Они предоставляют полное обучение, помогают с подбором персонала и дают готовые стандарты работы."},
    ],
    "Cafe": [
        {"q": "Сколько стоит открыть франшизу кафе или ресторана?", "a": "Инвестиции в франшизу общепита составляют от 800 000 до 10 000 000 рублей. Кофейни и стритфуд-форматы стоят дешевле, полноценные рестораны — дороже."},
        {"q": "Какая маржинальность у франшиз общепита?", "a": "Средняя маржинальность в общественном питании составляет 20-40%. Кофейни могут достигать 60% маржи на напитки, фастфуд — 25-35%."},
        {"q": "Что входит в паушальный взнос франшизы кафе?", "a": "Обычно в паушальный взнос входят: право на использование бренда, обучение команды, рецептуры, дизайн-проект помещения, маркетинговые материалы и IT-система управления."},
    ],
    "Fastfood": [
        {"q": "Какие самые популярные франшизы фастфуда в России?", "a": "Среди популярных форматов — шаурма, бургерные, пиццерии, суши-бары и блинные. Инвестиции начинаются от 250 000 рублей для компактных форматов."},
        {"q": "Сколько зарабатывает точка фастфуда по франшизе?", "a": "Средняя точка фастфуда приносит от 150 000 до 500 000 рублей чистой прибыли в месяц. Результат зависит от локации, проходимости и среднего чека."},
        {"q": "Какой формат фастфуда самый прибыльный?", "a": "Шаурма и кофе с собой показывают лучшую рентабельность благодаря низкой себестоимости и высокой оборачиваемости. Маржинальность может достигать 40-50%."},
    ],
    "Delivery": [
        {"q": "Выгодно ли открывать франшизу доставки?", "a": "Рынок доставки в России растёт на 20-30% ежегодно. Франшизы доставки еды и товаров показывают окупаемость от 6 до 18 месяцев при грамотном управлении."},
        {"q": "Какие вложения нужны для франшизы доставки?", "a": "Инвестиции в франшизу доставки составляют от 300 000 до 3 000 000 рублей. Основные затраты — транспорт, IT-платформа и маркетинг на старте."},
        {"q": "Нужен ли свой автопарк для франшизы доставки?", "a": "Не обязательно. Многие франшизы работают с курьерами на личном транспорте или предлагают аренду. Это снижает начальные инвестиции."},
    ],
    "Finance": [
        {"q": "Какие франшизы есть в сфере финансов?", "a": "В финансовом секторе представлены франшизы микрофинансовых организаций, страховых агентств, финансовых консультантов и бухгалтерских фирм."},
        {"q": "Сколько стоит финансовая франшиза?", "a": "Инвестиции варьируются от 500 000 до 5 000 000 рублей в зависимости от формата и лицензионных требований."},
        {"q": "Нужна ли лицензия для финансовой франшизы?", "a": "Для некоторых форматов (МФО, страхование) требуется лицензия ЦБ РФ. Франчайзер обычно помогает с оформлением необходимых документов."},
    ],
    "Healthcare": [
        {"q": "Можно ли открыть медицинскую франшизу без медицинского образования?", "a": "Да, владелец франшизы выступает как управляющий бизнесом. Медицинская лицензия оформляется на организацию, а для работы нанимаются квалифицированные специалисты."},
        {"q": "Сколько стоит франшиза в сфере здоровья?", "a": "Инвестиции в медицинские франшизы составляют от 1 000 000 до 10 000 000 рублей. Аптеки и ортопедические салоны стоят дешевле, клиники — дороже."},
        {"q": "Какой срок окупаемости у медицинской франшизы?", "a": "Средний срок окупаемости — 18-36 месяцев. Аптеки окупаются быстрее (12-18 мес.), стоматологии и клиники — дольше (24-36 мес.)."},
    ],
    "Sport": [
        {"q": "Сколько стоит франшиза фитнес-клуба?", "a": "Инвестиции в фитнес-франшизу составляют от 1 000 000 до 15 000 000 рублей. Компактные студии (EMS, йога) стоят от 1-3 млн, полноценные залы — от 5-15 млн."},
        {"q": "Выгодно ли открывать спортивную франшизу?", "a": "Рынок фитнеса в России растёт. Средняя маржинальность — 30-50%. Студийные форматы (пилатес, кроссфит) показывают быструю окупаемость за 12-18 месяцев."},
        {"q": "Какой формат спортивной франшизы самый востребованный?", "a": "Растёт спрос на компактные студийные форматы: EMS-тренировки, студии растяжки, функциональный тренинг. Они требуют меньше площади и инвестиций."},
    ],
    "Technology": [
        {"q": "Какие технологические франшизы доступны?", "a": "В IT-сфере представлены франшизы сервисных центров, школ программирования, digital-агентств и компаний по ремонту техники. Инвестиции — от 300 000 рублей."},
        {"q": "Нужны ли технические знания для IT-франшизы?", "a": "Для большинства франшиз технические знания не требуются. Франчайзер обучает персонал и предоставляет IT-инфраструктуру. Ваша задача — управление бизнесом."},
        {"q": "Какой срок окупаемости у технологической франшизы?", "a": "Средний срок окупаемости — 12-24 месяца. Сервисные центры и ремонт техники окупаются быстрее всего благодаря высокой маржинальности услуг."},
    ],
}

INVESTMENT_FAQ = {
    "do-500k": [
        {"q": "Какие франшизы можно купить до 500 тысяч рублей?", "a": "За бюджет до 500 000 рублей доступны франшизы в сфере услуг, онлайн-образования, мелкого ремонта, клининга и компактного стритфуда. Многие из них не требуют аренды отдельного помещения."},
        {"q": "Реально ли заработать на франшизе за 500 тысяч?", "a": "Да, бюджетные франшизы часто показывают высокую рентабельность. Средняя чистая прибыль — 80 000-200 000 рублей в месяц при окупаемости 6-14 месяцев."},
        {"q": "На что обратить внимание при покупке недорогой франшизы?", "a": "Проверьте: что включено в паушальный взнос, размер роялти, реальные отзывы франчайзи, наличие обучения и поддержки. Низкая цена — не всегда выгодная покупка."},
    ],
    "do-1m": [
        {"q": "Какие франшизы доступны до 1 миллиона рублей?", "a": "В бюджете до 1 000 000 рублей доступны кофейни, барбершопы, детские центры, пункты выдачи заказов, сервисные центры и многие другие форматы бизнеса."},
        {"q": "Какой средний срок окупаемости франшизы до 1 млн?", "a": "Франшизы в этом бюджете окупаются в среднем за 10-18 месяцев. Быстрее всего — сервисные форматы и стритфуд (8-12 месяцев)."},
        {"q": "Стоит ли брать кредит на покупку франшизы?", "a": "Многие банки дают льготные кредиты на франчайзинг. Главное — выбрать франшизу с подтверждённой финансовой моделью и заложить запас на 3-6 месяцев операционных расходов."},
    ],
    "ot-1m-do-5m": [
        {"q": "Какие франшизы можно купить за 1-5 миллионов?", "a": "Это самый популярный сегмент: рестораны, салоны красоты, медицинские кабинеты, фитнес-студии, образовательные центры, магазины и сервисные компании."},
        {"q": "Какая прибыль у франшизы за 1-5 млн рублей?", "a": "Средняя чистая прибыль — 200 000-700 000 рублей в месяц. Общепит и медицина — в верхней части диапазона, услуги и образование — в средней."},
        {"q": "Как выбрать франшизу в среднем ценовом сегменте?", "a": "Сравните 5-7 франшиз по ключевым параметрам: окупаемость, поддержка, количество точек в сети, отзывы действующих партнёров. Обязательно посетите работающие точки."},
    ],
    "ot-5m": [
        {"q": "Что можно открыть по франшизе за 5+ миллионов?", "a": "За бюджет от 5 млн доступны крупные форматы: полноценные рестораны, фитнес-клубы, медицинские клиники, сетевые магазины и образовательные учреждения."},
        {"q": "Оправданы ли большие инвестиции во франшизу?", "a": "Крупные франшизы обычно имеют сильный бренд, отлаженные бизнес-процессы и более высокую прибыль. Срок окупаемости — 18-36 месяцев, но ежемесячная прибыль значительно выше."},
        {"q": "Какие гарантии дают премиальные франшизы?", "a": "Топовые франчайзеры предоставляют эксклюзивную территорию, полное обучение и сопровождение, маркетинговую поддержку и помощь в поиске помещения. Некоторые гарантируют минимальную выручку."},
    ],
}
...
def franchises_list(request):
    ...
    if is_ajax:
        ...
        context = {
            ...
            "faq_items": GENERAL_FRANCHISE_FAQ,
        }
...
def franchises_by_direction(request, direction_slug):
    ...
    context = {
        ...
        "faq_items": DIRECTION_FAQ.get(direction.direction_name, []),
    }
    return render(request, "accounts/franchises_list.html", context)
...
def franchises_by_investment(request, range_slug):
    ...
    context = {
        ...
        "franchises_count": count,
        "faq_items": INVESTMENT_FAQ.get(range_slug, []),
    }
    return render(request, "accounts/franchises_list.html", context)
