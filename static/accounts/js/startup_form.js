document.addEventListener('DOMContentLoaded', function () {
  ...
  function openConsentModalInstant(docNumber){
    ...
    var policyText = `ПОЛИТИКА КОНФИДЕНЦИАЛЬНОСТИ
...
12.2. Почтовый адрес для корреспонденции: 350058, Краснодарский край, Краснодар г., Ставропольская ул., дом 336/3, офис ПОМЕЩ.`
    var consentText = `Согласие на обработку персональных данных
Нажимая «Отправить», я даю согласие на обработку моих персональных данных (ФИО, телефон, email) сайтом https://www.greatideas.ru в целях связи, оказания услуг, маркетинга и формирования рекламных аудиторий.
