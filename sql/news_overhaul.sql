-- ============================================================
-- News/Blog System Overhaul — Database Migration
-- Run this SQL against PostgreSQL BEFORE deploying new code
-- ============================================================
...
-- Seed initial categories (matching existing sidebar checkboxes)
